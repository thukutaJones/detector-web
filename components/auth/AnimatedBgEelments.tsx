        ...
        <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full">
                <ParallaxShape intensity={10}>
                    <div className="absolute top-20 left-20 w-2 h-2 bg-green-500 rounded-full animate-ping" />
                </ParallaxShape>
                ...
                <ParallaxShape intensity={8}>
                    <div className="absolute bottom-40 left-40 w-1 h-1 bg-green-600 rounded-full animate-pulse" />
                </ParallaxShape>
            </div>
